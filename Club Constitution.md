 ...
 * Strategy Lead should be in charge of reading the rule book and being an expert on it
  ...
  *Must determine the order of priority for the construction of the Field Elements and ensure Field/ Field Element construction is built to game manual specifications
  ...
  *Strategy Lead is responsible for the the Strategy sub leads executing appropriate strategic procedures at competitions, including but limited to, scouting, match strategizing, briefing drive team, post-match analysis, etc.
  *Strategy lead must be knowledgable or be advised on software, espicially autonomous software, that is potentially uselful to auto and game strategies
  *Strategy Lead will advise Software Department on autonomous code and strategies pertaining to the overall Strategy
  *Strategy Lead manages and/or oversees the creation of the Reveal Video or any other public reveal and decides what information to and not to reveal interest of long term strategies.
* Build Specialist
...
* Software lead
  ...
  * Help Drivers understand and use robot control software.
  Advise Strategy Lead on software, espicially autonomous software, that is potentially uselful to auto and game strategies, if needed.
...
* Design Specialist
  ...
  * Join Strategy Department to draft the Design Platform
  * Review the Design Platform presented by the Strategy Lead, propose changes if nesscarry and freeze by signing.
  * Have co-managers (design and hardware specialists) lead the engineering department
